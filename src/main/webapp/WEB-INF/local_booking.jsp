...
<script>
	function CalculatePrice()
	{
	  ...
	  var vahicle = document.getElementById('vehicle').value; 
	  var vehicleNo = document.getElementById('vehicleNo').value;
	  var price = vehicleNo * price;
	...
	<div class="container">
		<div class="card card-signin my-5">
			<div class="card-body">
				...
				<form class="form-signin" action="/save" method="post" onChange="CalculatePrice()">
					<div class="row">
						<div class="col-md-4">
					...
					<div class="row">
						...
						<div class="col-md-4">
							<div class="form-group">
								<b> <label for="Area">Area(Bhubaneswar)</label></b> 
					...
					<div class="row">
						...
						<div class="col-md-4">
							<div class="form-group">
								<b> <label for="Vehicle">Vehicle Type</label></b> 
								<select class="form-control" id="vahicle">
						...
						<div class="col-md-4">
							<div class="form-group">
								<b> <label for="numberofvehicle">Number Of Vehicle</label></b> <input
									type="text" name="numberOfVehice" id="vahicleNo" class="form-control"
									placeholder="Enter no.of vehicles">
							</div>
						</div>
						<div class="col-md-4">
							<div class="form-group">
								<b> <label for="price">Price</label></b> <input type="text"name="price" class="form-control" placeholder="">
							</div>
						</div>
					</div>
			</div>
