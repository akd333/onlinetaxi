	...
	<div class="banner" id="home">
		...
		<div id="wrapper">
			...
			<script>successMessage("${book}")
									...
									<center><button type="submit" class="btn1 btn-primary submit"  style="font-size:200%"><i class="fas fa-paper-plane" aria-hidden="true"></i>Book Now</button></center>
								</form>
								</div>
							</div>
						</div>
					...
					<li>
						<div class="banner-img two">
							<div class="bs-slider-overlay">
								<div class="banner-info text-center">
									<span class="fas fa-taxi"></span>
									<h4>No Waiting Charges</h4><br><br>
									<form action="booktaxi"  >
									<center><button type="submit" class="btn1 btn-primary submit" style="font-size:200%"><i class="fas fa-paper-plane" aria-hidden="true"></i>Book Now</button></center>
								</form>
								</div>
...
<section class="about py-5">
	<div class="container py-lg-5 py-3">
		...
		<p>Discover. Experince
A convenient and flexible way to travel to and from Biju Pattanaik International Airport, Bhubaneswar.
We understand the needs of businesses and have tailored our services to ensure that our clients receive a hassle-free rental experience.
We are pioneer in the car rental industry with the expertise to deliver the best in class car hire and car leasing services to corporate</p><br/>
	...
	<div class="container py-lg-5 py-3">
		...
		<div class="row pricing-grids">
			<div class="col-lg-3 col-md-6 price-grid">
				<h3 class="mb-4">Micro Taxi -- <span class="">Rs 200</span></h3>
				
			</div>
			<div class="col-lg-3 col-md-6 mt-md-0 mt-5 price-grid">
				<h3 class="mb-4">Mini Taxi -- <span class="">Rs 400</span></h3>
				
			</div>
			<div class="col-lg-3 col-md-6 mt-lg-0 mt-5 price-grid">
				<h3 class="mb-4">Prime Taxi -- <span class="">Rs 600</span></h3>
				
			</div>
			<div class="col-lg-3 col-md-6 mt-lg-0 mt-5 price-grid">
				<h3 class="mb-4">Sedan Taxi -- <span class="">Rs 800</span></h3>
